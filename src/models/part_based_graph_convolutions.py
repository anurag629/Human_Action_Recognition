...
class PartBasedGraphConvolutionalNetwork(nn.Module):
    def __init__(self, num_classes, input_shape):
        super(PartBasedGraphConvolutionalNetwork, self).__init__()
        ...
        conv_output_size = 128 * (input_shape[0] // 4) * (input_shape[1] // 4)
